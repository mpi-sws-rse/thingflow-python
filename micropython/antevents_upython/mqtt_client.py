"""MQTT client.
Originally derived from https://github.com/andrewmk/uMQTT.
Thus, it is under the GPL license.
...
def test(host='localhost'):
  s = connect('wypy1', host)
  print("Publishing...")
  publish(s, "wipytopic", b'wipy-data')
  time.sleep(10)
  publish(s, "wipytopic", b'wipy-data-again')
  disconnect(s)
