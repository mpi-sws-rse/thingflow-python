...
TESTS="test_base test_iterable_as_publisher test_external_event_stream test_multiple_pubtopics test_linq test_transducer test_scheduler_cancel test_fatal_error_handling test_fatal_error_in_private_loop test_blocking_publisher test_solar_heater_scenario test_timeout test_blocking_subscriber test_postgres_adapters test_mqtt test_mqtt_async test_csv_adapters test_functional_api"
