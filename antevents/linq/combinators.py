...
thunk, compose, and passthrough. A linq-style function takes the previous
...
The Scheduler.schedule_sensor() method and compose() below can accept
thunks in place filters. The thunk() function converts a multiparameter
linq-style function to a thunk.
"""
